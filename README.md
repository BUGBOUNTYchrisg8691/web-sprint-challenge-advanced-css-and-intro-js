...
User, regardless of their lifestyle, ailments or any choices, should be able to use your website.
2. Talk about 3 different things you can do to ensure your website is accessible. 
colorschemes, alt for images, responsive design for smaller or larger screens
3. How would you explain the concept of a variable to someone new to programming?
value defined by the programmer
